...
homie_handle_t homie = {
    .deviceid = "sentio-b2-control",
    .devicename = "sentiotec Pro-B2 control",
    .update_interval =
    ...
    .num_nodes = 1,
    .nodes = {{.id = "sentio-b2-control",
               .name = "Sentio B2 control",
               .type = "B2",
               .num_properties = 9,
               .properties =
                   {
                       ...
                       },
                       {
                           ...
                           .write_property_cbk = &write_timer,
                           .user_data = NULL,
                       },
                       {
                           .id = "heattimer",
                           ...
                           .write_property_cbk = &write_heattimer,
                           .user_data = NULL,
                       },
                       {
                           .id = "target_temp",
                           ...
                           .write_property_cbk = &write_target_temp,
                           .user_data = NULL,
                       },
                       {
                           .id = "timer_value",
                           ...
                           .write_property_cbk = &write_timer_value,
                           .user_data = NULL,
                       },
                       {
                           .id = "heater_temp",
...
static esp_err_t wifi_event_handler(void *ctx, system_event_t *event)
{
    ...
    case SYSTEM_EVENT_STA_START: {
            ...
            esp_err_t err;
            char hostname[33] = {0};
            snprintf(hostname, 33, "sentio-b2");
